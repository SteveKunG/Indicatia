...
public class GuiFunctionHelpSlot extends GuiSlot
{
    ...
    {
        this.mc.fontRendererObj.drawStringWithShadow(TextFormatting.YELLOW + "\u25cf " + function + TextFormatting.RESET + "- " + desc, x, y, 16777215);
    }

    private void drawMainFunction(String text, int x, int y)
    {
        this.mc.fontRendererObj.drawStringWithShadow(TextFormatting.YELLOW + "- " + text, x, y, 16777215);
    }
}
...
public abstract class MixinHumanoidArmorLayer<T extends LivingEntity, M extends HumanoidModel<T>, A extends HumanoidModel<T>>
{
    ...
    {
        this.indicatia$renderArmorModified(_poseStackIn, _bufferIn, entityLivingBaseIn, _packedLightIn, armorItem, glintIn, modelIn, legs, red, green, blue, armorResource);
    }

    private void indicatia$renderArmorModified(PoseStack poseStack, MultiBufferSource buffer, T entity, int packedLight, ArmorItem armorItem, boolean glint, A model, boolean legs, float red, float green, float blue, String armorResource)
    {

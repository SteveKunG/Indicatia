...
public class GuiDonator extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.topDonateInput = new GuiTextField(this.fontRendererObj, this.width / 2 - 150, 60, 300, 20);
        ...
        this.recentDonateInput = new GuiTextField(this.fontRendererObj, this.width / 2 - 150, 85, 300, 20);
        ...
        this.topDonateTextInput = new GuiTextField(this.fontRendererObj, this.width / 2 - 150, 110, 300, 20);
        ...
        this.recentDonateTextInput = new GuiTextField(this.fontRendererObj, this.width / 2 - 150, 135, 300, 20);
        ...
        this.buttonList.add(this.doneBtn = new GuiButton(0, this.width / 2 - 50 - 100 - 4, this.height / 4 + 120, 100, 20, LangUtil.translate("gui.done")));
        this.buttonList.add(this.cancelBtn = new GuiButton(1, this.width / 2 + 50 + 4, this.height / 4 + 120, 100, 20, LangUtil.translate("gui.cancel")));
        this.buttonList.add(this.resetBtn = new GuiButton(2, this.width / 2 - 50, this.height / 4 + 120, 100, 20, "Reset Path"));
    ...
    protected void actionPerformed(GuiButton button)
    {
        ...
        if (button.enabled)
        {
            if (button.id == 0)
            {
                ...
                {
                    this.mc.thePlayer.addChatMessage(json.text("Set top donator file path to " + this.topDonateInput.getText()));
                }
                if (!ExtendedConfig.RECENT_DONATOR_FILE_PATH.equals(this.recentDonateInput.getText()))
                {
                    this.mc.thePlayer.addChatMessage(json.text("Set recent donator file path to " + this.recentDonateInput.getText()));
                }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, EnumChatFormatting.RESET + "Top Donate Text: " + this.convertString(this.topDonateTextInput.getText()), this.width / 2, 170, 10526880);
        this.drawCenteredString(this.fontRendererObj, EnumChatFormatting.RESET + "Recent Donate Text: " + this.convertString(this.recentDonateTextInput.getText()), this.width / 2, 185, 10526880);
    ...
    {
        for (EnumChatFormatting formatting : GuiDonator.valuesCached())
        {
            if (original.contains("&" + formatting.getFormattingCode()))
            {
                original = original.replace("&" + formatting.getFormattingCode(), "\u00a7" + formatting.getFormattingCode());
            }
        }
        return original;
    }

    private static EnumChatFormatting[] valuesCached()
    {

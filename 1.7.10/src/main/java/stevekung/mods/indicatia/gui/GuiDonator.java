...
public class GuiDonator extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.topDonateInput = new GuiTextField(this.fontRendererObj, this.width / 2 - 150, this.height / 4 - 20, 300, 20);
        ...
        this.recentDonateInput = new GuiTextField(this.fontRendererObj, this.width / 2 - 150, this.height / 4 + 20, 300, 20);
        ...
        this.buttonList.add(this.resetBtn = new GuiButton(2, this.width / 2 - 50, this.height / 4 + 100 + 12, 100, 20, "Reset Path"));

...
public class ColoredFontRenderer extends FontRenderer
{
    ...
    @Override
    public int renderString(String text, int x, int y, int color, boolean dropShadow)
    {
    ...
    @Override
    public float renderCharAtPos(int ascii, char charac, boolean italic)
    {
        ...
        {
            value = super.renderCharAtPos(ascii, charac, italic);
        }
        return value;
    }

...
public class ExtendedConfig
{
    ...
    private static NBTTagList writeAutoLoginData()
    {
        ...
        for (AutoLoginData login : ExtendedConfig.loginData.getAutoLoginList())
        {
            ...
            nbt.setString("UUID", login.getUUID());
            list.appendTag(nbt);
        }
        return list;
    }
    ...
    private static void readAutoLoginData(NBTTagList list)
    {
        for (int i = 0; i < list.tagCount(); ++i)
        {
            ...
            ExtendedConfig.loginData.addAutoLogin(nbt.getString("ServerIP"), nbt.getString("CommandName"), nbt.getString("Value"), nbt.getString("UUID"));
        }
    }

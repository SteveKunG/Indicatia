...
public class KeystrokeRenderer
{
    ...
    private static void renderStyleNormal(Minecraft mc, SmallFontRenderer smallFontRenderer, int width)
    {
        ...
        Gui.func_146110_a(width - widthSquare + 20, heightSquare, wDown ? 24 : 0, 0, 24, 24, 48, 24);
        Gui.func_146110_a(width - widthSquare - 4, heightSquare + 24, aDown ? 24 : 0, 0, 24, 24, 48, 24);
        Gui.func_146110_a(width - widthSquare + 20, heightSquare + 24, sDown ? 24 : 0, 0, 24, 24, 48, 24);
        Gui.func_146110_a(width - widthSquare + 44, heightSquare + 24, dDown ? 24 : 0, 0, 24, 24, 48, 24);
        ...
        mc.fontRenderer.drawString("W", (int) (width - widthSquare + 29.5F), heightSquare + 9, wDown ? 0 : useRainbow ? rainbow : RenderUtil.to32BitColor(255, (int)r, (int)g, (int)b), false);
        mc.fontRenderer.drawString("A", (int) (width - widthSquare + 5.5F), heightSquare + 32, aDown ? 0 : useRainbow ? rainbow : RenderUtil.to32BitColor(255, (int)r, (int)g, (int)b), false);
        mc.fontRenderer.drawString("S", (int) (width - widthSquare + 29.5F), heightSquare + 32, sDown ? 0 : useRainbow ? rainbow : RenderUtil.to32BitColor(255, (int)r, (int)g, (int)b), false);
        mc.fontRenderer.drawString("D", (int) (width - widthSquare + 53.5F), heightSquare + 32, dDown ? 0 : useRainbow ? rainbow : RenderUtil.to32BitColor(255, (int)r, (int)g, (int)b), false);

        if (ConfigManager.enableKeystrokeLMBRMB)
        {
            RenderUtil.bindKeystrokeTexture("mouse_square");
            Gui.func_146110_a(width - widthSquare - 4, heightSquare - 12, lmbDown ? 24 : 0, 0, 24, 36, 48, 36);
            Gui.func_146110_a(width - widthSquare + 44, heightSquare - 12, rmbDown ? 24 : 0, 0, 24, 36, 48, 36);
            ...
            mc.fontRenderer.drawString("LMB", (int) (width - widthSquare - 0.5F), heightSquare - 4, lmbDown ? 0 : useRainbow ? rainbow : RenderUtil.to32BitColor(255, (int)r, (int)g, (int)b), false);
            mc.fontRenderer.drawString("RMB", (int) (width - widthSquare + 47.5F), heightSquare - 4, rmbDown ? 0 : useRainbow ? rainbow : RenderUtil.to32BitColor(255, (int)r, (int)g, (int)b), false);
        ...
        if (ConfigManager.enableKeystrokeSprintSneak)
        {
            ...
            Gui.func_146110_a(width - widthSquare + 2, heightSquare + 48, sprintDown ? 20 : 0, 0, 20, 20, 40, 20);
            Gui.func_146110_a(width - widthSquare + 22, heightSquare + 48, sneakDown ? 20 : 0, 0, 20, 20, 40, 20);
            ...
            Gui.func_146110_a(width - widthSquare + 2, heightSquare + 48, sprintDown ? 0 : 20, 0, 20, 20, 40, 20);
            ...
            GL11.glColor3f(useRainbow ? red : r, useRainbow ? green : g, useRainbow ? blue : b);
            Gui.func_146110_a(width - widthSquare + 22, heightSquare + 48, sneakDown ? 0 : 20, 0, 20, 20, 40, 20);
        }
        if (ConfigManager.enableKeystrokeBlocking)
        {
            RenderUtil.bindKeystrokeTexture("button_square_2");
            Gui.func_146110_a(width - widthSquare + 42, heightSquare + 48, blockDown ? 20 : 0, 0, 20, 20, 40, 20);
            ...
            GL11.glColor3f(useRainbow ? red : r, useRainbow ? green : g, useRainbow ? blue : b);
            Gui.func_146110_a(width - widthSquare + 42, heightSquare + 48, blockDown ? 0 : 20, 0, 20, 20, 40, 20);
        }

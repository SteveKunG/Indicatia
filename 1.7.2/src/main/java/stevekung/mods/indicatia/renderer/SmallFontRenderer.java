...
public class SmallFontRenderer implements IResourceManagerReloadListener
{
    ...
    private void readFontTexture()
    {
        ...
        try
        {
            bufferedimage = ImageIO.read(this.getResource(SmallFontRenderer.LOCATION_FONT_TEXTURE));
        }
    ...
    private void doDraw(float f)
    {
        ...
        if (this.strikethroughStyle)
        {
            ...
            tessellator.addVertex(this.posX + f, this.posY + this.FONT_HEIGHT / 2, 0.0D);
            tessellator.addVertex(this.posX + f, this.posY + this.FONT_HEIGHT / 2 - 1.0F, 0.0D);

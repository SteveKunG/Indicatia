...
public class GuiAutoLoginFunction extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.inputField = new GuiTextField(2, this.fontRendererObj, this.width / 2 - 150, this.height / 4 + 65, 300, 20);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, "Auto Login Function", this.width / 2, this.height / 4, 16777215);
        this.drawCenteredString(this.fontRendererObj, "Put your own bot function to make it run automatically", this.width / 2, this.height / 4 + 20, 10526880);

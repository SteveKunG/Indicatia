...
public class KeyBindingHandler
{
    ...
    public static FabricKeyBinding DONATOR;
    ...
    public static void init()
    {
        ...
        KeyBindingHandler.DONATOR = FabricKeyBinding.Builder.create(new Identifier("indicatia:donator_gui.desc"), InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_F6, IndicatiaMod.MOD_ID).build();

...
public class LayerCustomCape implements LayerRenderer<AbstractClientPlayer>
{
    ...
    {
        if (ConfigManagerIN.indicatia_general.enableCustomCape && entity.getName().equals(GameProfileUtils.getUsername()) && !entity.isInvisible() && ExtendedConfig.instance.showCustomCape && CapeUtils.CAPE_TEXTURE != null)
        {

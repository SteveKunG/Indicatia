...
public class KeystrokeRenderer
{
    ...
    private static void renderDefaultStyle(Minecraft mc, int width)
    {
        ...
        AbstractGui.blit(width - widthSquare + 20, heightSquare, wDown ? 24 : 0, 0, 24, 24, 48, 24);
        AbstractGui.blit(width - widthSquare - 4, heightSquare + 24, aDown ? 24 : 0, 0, 24, 24, 48, 24);
        AbstractGui.blit(width - widthSquare + 20, heightSquare + 24, sDown ? 24 : 0, 0, 24, 24, 48, 24);
        AbstractGui.blit(width - widthSquare + 44, heightSquare + 24, dDown ? 24 : 0, 0, 24, 24, 48, 24);
        useRainbow = ExtendedConfig.instance.keystrokeWASDRainbow;
        mc.fontRenderer.drawString("W", width - widthSquare + 29.0625F, heightSquare + 9, wDown ? 0 : useRainbow ? rainbow : ColorUtils.stringToRGB(ExtendedConfig.instance.keystrokeWASDColor).to32Bit());
        mc.fontRenderer.drawString("A", width - widthSquare + 5.0625F, heightSquare + 32, aDown ? 0 : useRainbow ? rainbow : ColorUtils.stringToRGB(ExtendedConfig.instance.keystrokeWASDColor).to32Bit());
        mc.fontRenderer.drawString("S", width - widthSquare + 29.0625F, heightSquare + 32, sDown ? 0 : useRainbow ? rainbow : ColorUtils.stringToRGB(ExtendedConfig.instance.keystrokeWASDColor).to32Bit());
        mc.fontRenderer.drawString("D", width - widthSquare + 53.0625F, heightSquare + 32, dDown ? 0 : useRainbow ? rainbow : ColorUtils.stringToRGB(ExtendedConfig.instance.keystrokeWASDColor).to32Bit());

        if (ExtendedConfig.instance.keystrokeMouse)
        {
            RenderUtilsIN.bindKeystrokeTexture("mouse_square");
            AbstractGui.blit(width - widthSquare - 4, heightSquare - 12, lmbDown ? 24 : 0, 0, 24, 36, 48, 36);
            AbstractGui.blit(width - widthSquare + 44, heightSquare - 12, rmbDown ? 24 : 0, 0, 24, 36, 48, 36);
            useRainbow = ExtendedConfig.instance.keystrokeMouseButtonRainbow;
            mc.fontRenderer.drawString("LMB", width - widthSquare - 0.5625F, heightSquare - 4, lmbDown ? 0 : useRainbow ? rainbow : ColorUtils.stringToRGB(ExtendedConfig.instance.keystrokeMouseButtonColor).to32Bit());
            mc.fontRenderer.drawString("RMB", width - widthSquare + 47.5625F, heightSquare - 4, rmbDown ? 0 : useRainbow ? rainbow : ColorUtils.stringToRGB(ExtendedConfig.instance.keystrokeMouseButtonColor).to32Bit());
            ...
            if (ExtendedConfig.instance.cps && ExtendedConfig.instance.cpsPosition == CPSPosition.KEYSTROKE)
            {
                ...
                if (lmbDown)
                {
                    ColorUtils.coloredFontRendererUnicode.drawString(cps, width - widthSquare + 8.0625F - smallFontWidth / 2, heightSquare + 12, lmbDown ? 0 : useRainbow ? rainbow : ColorUtils.stringToRGB(ExtendedConfig.instance.keystrokeCPSColor).to32Bit());
                }
                else
                {
                    ColorUtils.coloredFontRendererUnicode.drawStringWithShadow(cps, width - widthSquare + 8.0625F - smallFontWidth / 2, heightSquare + 12, lmbDown ? 0 : useRainbow ? rainbow : ColorUtils.stringToRGB(ExtendedConfig.instance.keystrokeCPSColor).to32Bit());
                }
            }
            ...
            if (ExtendedConfig.instance.rcps && ExtendedConfig.instance.cpsPosition == CPSPosition.KEYSTROKE)
            {
                ...
                if (rmbDown)
                {
                    ColorUtils.coloredFontRendererUnicode.drawString(rcps, width - widthSquare + 56.0625F - smallFontWidth / 2, heightSquare + 12, rmbDown ? 0 : useRainbow ? rainbow : ColorUtils.stringToRGB(ExtendedConfig.instance.keystrokeRCPSColor).to32Bit());
                }
                else
                {
                    ColorUtils.coloredFontRendererUnicode.drawStringWithShadow(rcps, width - widthSquare + 56.0625F - smallFontWidth / 2, heightSquare + 12, rmbDown ? 0 : useRainbow ? rainbow : ColorUtils.stringToRGB(ExtendedConfig.instance.keystrokeRCPSColor).to32Bit());
                }
            }
        }
        if (ExtendedConfig.instance.keystrokeSprintSneak)
        {
            ...
            AbstractGui.blit(width - widthSquare + 2, heightSquare + 48, sprintDown ? 20 : 0, 0, 20, 20, 40, 20);
            AbstractGui.blit(width - widthSquare + 22, heightSquare + 48, sneakDown ? 20 : 0, 0, 20, 20, 40, 20);
            ...
            AbstractGui.blit(width - widthSquare + 2, heightSquare + 48, sprintDown ? 0 : 20, 0, 20, 20, 40, 20);
            ...
            AbstractGui.blit(width - widthSquare + 22, heightSquare + 48, sneakDown ? 0 : 20, 0, 20, 20, 40, 20);
        }
        if (ExtendedConfig.instance.keystrokeBlocking)
        {
            RenderUtilsIN.bindKeystrokeTexture("button_square_2");
            AbstractGui.blit(width - widthSquare + 42, heightSquare + 48, blockDown ? 20 : 0, 0, 20, 20, 40, 20);
            ...
            AbstractGui.blit(width - widthSquare + 42, heightSquare + 48, blockDown ? 0 : 20, 0, 20, 20, 40, 20);
        }

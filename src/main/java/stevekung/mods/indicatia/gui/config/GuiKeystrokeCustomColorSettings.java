...
public class GuiKeystrokeCustomColorSettings extends Screen
{
    ...
    public void init()
    {
        ...
        this.optionsRowList = new GuiConfigTextFieldRowList(this.width, this.height, 32, this.height - 32, 25);
    ...
    public void render(int mouseX, int mouseY, float partialTicks)
    {
        ...
        {
            GuiTextFieldExtended textField = this.optionsRowList.getFocused().getTextField();

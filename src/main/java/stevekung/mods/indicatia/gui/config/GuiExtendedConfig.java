...
public class GuiExtendedConfig extends Screen
{
    ...
    public void init()
    {
        ...
        {
            ExtendedConfig.instance.save();
            GuiExtendedConfig.this.minecraft.displayGuiScreen(new ConfirmScreen(this::resetConfig, LangUtils.translateComponent("menu.reset_config_confirm"), JsonUtils.create("")));
        }));

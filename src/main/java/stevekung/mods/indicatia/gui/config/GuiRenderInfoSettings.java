...
public class GuiRenderInfoSettings extends Screen
{
    ...
    public void render(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.minecraft.textRenderer, Formatting.YELLOW + LangUtils.translate("extended_config.render_info.rclick.info"), this.width / 2, 15, 16777215);

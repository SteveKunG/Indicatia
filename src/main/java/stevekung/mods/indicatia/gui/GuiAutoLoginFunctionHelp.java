...
public class GuiAutoLoginFunctionHelp extends GuiScreen
{
    ...
    {
        this.inGui = inGui;
        this.res = new ScaledResolution(IndicatiaMod.MC, IndicatiaMod.MC.displayWidth, IndicatiaMod.MC.displayHeight);
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, "Auto Login Function", this.width / 2, 20, 16777215);

...
//
//@OnlyIn(Dist.CLIENT)
//public class GuiFunctionHelpSlot extends AlwaysSelectedItemListWidget
//{
...
//    {
//        super(MinecraftClient.getInstance(), width, height, 32, height - 48, 13);
...
//
//    @Override
//    protected void render(int entryID, int insideLeft, int yPos, int insideSlotHeight, int mouseXIn, int mouseYIn, float partialTicks)
//    {

...
public class GuiFunctionHelpSlot extends GuiSlot
{
    ...
    {
        this.parent.drawCenteredString(this.mc.fontRendererObj, "Auto Login Function", this.width / 2, 16, 16777215);
    ...
    {
        this.mc.fontRendererObj.drawStringWithShadow(EnumChatFormatting.YELLOW + "\u25cf " + function + EnumChatFormatting.RESET + "- " + desc, x, y, 16777215);
    }

    private void drawMainFunction(String text, int x, int y)
    {
        this.mc.fontRendererObj.drawStringWithShadow(EnumChatFormatting.YELLOW + "- " + text, x, y, 16777215);
    }
}
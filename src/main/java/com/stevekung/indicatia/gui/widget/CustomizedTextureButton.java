...
@OnlyIn(Dist.CLIENT)
public class CustomizedTextureButton extends Button
{
    private final String texture;
    private final Screen parent;
    private final List<String> tooltips;

    public CustomizedTextureButton(int xPos, int yPos, Screen parent, List<String> tooltips, String texture, Button.IPressable button)
    {

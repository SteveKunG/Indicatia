...
public abstract class ConfigSliderWidget extends ExtendedWidget
{
    ...
    protected void renderBg(MatrixStack matrixStack, Minecraft mc, int x, int y)
    {
        ...
        this.blit(matrixStack, this.x + (int)(this.value * (this.width - 8)), this.y, 0, 46 + index, 4, 20);
        this.blit(matrixStack, this.x + (int)(this.value * (this.width - 8)) + 4, this.y, 196, 46 + index, 4, 20);
    }

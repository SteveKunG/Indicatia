...
{
    public static void render(SkullBlock.ISkullType skullType, @Nullable GameProfile gameProfile, MatrixStack matrixStack, IRenderTypeBuffer buffer, int combinedLight, boolean glint)
    {
        ...
        genericheadmodel.render(matrixStack, ivertexbuilder, combinedLight, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F, 1.0F);
        matrixStack.pop();
    }
}